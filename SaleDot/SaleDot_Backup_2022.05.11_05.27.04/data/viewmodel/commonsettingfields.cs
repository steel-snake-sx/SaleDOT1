...
namespace SaleDot.data.viewmodel
{
    public class commonsettingfields
    {
        ...
        public static string ravicosoftFreePOSmembershipplan = "ravicosoftFreePOSmembershipplan"; // values are '',undefined,Package 1,Package 2,Package 3,Custom
