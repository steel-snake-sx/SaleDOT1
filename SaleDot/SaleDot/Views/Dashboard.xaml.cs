...
namespace SaleDot.Views
{
    ...
    public partial class Dashboard : Window
    {
        ...
        void loaccounts()
        {
            ...
            {
                sales = -financetransactionrepo.gettransactionsumbyaccountnamesandfromtodate(new string[] { "Продажа", "Продажа", "Продажа услуг" }, DateTime.Now, DateTime.Now);
            ...
            <body style='background-color:#f0f0f0' scroll='no'>
              <div class='main'>
                <div class='blocks'>
                  ...
                  <p class='a' >" + sales + @" <span class=>₽</span> </p>
                  <span class='footer'>Всего продаж</span>
                </div>
                <div class='blocks'>
                  <span class='title'>Клиент</span>
                   <p class='b'>" + customers + @"</p>
                    <span class='footer'>Включены все типы</span>
                </div>
                <div class='blocks'>
                ...
                <div class='blocks'>
                  <span class='title'>Персонал</span>
                   <p class='d'>" + users + @"</p>
                    <span class='footer'>Всего пользователей</span>
                </div>
              <div>
            </body>
            </html>";
        ...
        {
            var w = new Views.finance.salespurchases("Продажа");
            userutils.authorizerole(w, new string[] { "superadmin", "admin" });
        }
        ...
        {
            var w = new Views.finance.salespurchases("Покупка запасов");
            userutils.authorizerole(w, new string[] { "superadmin", "admin" });
        }
